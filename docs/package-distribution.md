...
[GitHub Release](https://github.com/mindful-time/smells/releases/tag/v0.5.0).
...
| PyPI | `smells` | `uv tool install smells==0.5.0` | prebuilt native wheel; no sdist |
| npm | `@mindful-time/smells` | `npm install --save-dev --save-exact @mindful-time/smells@0.5.0` | exact-version optional native package |
...
| crates.io | `smells` | `cargo install --locked --version 0.5.0 smells` | builds from source with Rust 1.88 |
